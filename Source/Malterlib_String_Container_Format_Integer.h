...
#undef DUnrollCode
		...
		class TCStringFormatter<t_CFormatter, NMath::TCInt<t_CInt0, t_CInt1> >
		{
		public:
			typedef TCStrFormatType_Int<t_CFormatter, NMath::TCInt<t_CInt0, t_CInt1> const &> CFormatType;
			static inline_large typename CFormatType::CStrFormatTypeClassifier fs_CreateFormat(t_CFormatter &_Formatter, NMath::TCInt<t_CInt0, t_CInt1> const&_Data)
			{
